...
# For now assume that the clients repository is a sibling to
# the current working directory.
out_path = os.path.abspath(os.path.join("../", f"clients"))

mod = importlib.import_module(f"app.app")
...
def _generate(generator: str):
    p = os.path.abspath(os.path.join(out_path, generator))
